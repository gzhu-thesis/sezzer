                ...
                if header.mask & inotify.constants.IN_ISDIR:
                    ...
                    if (
                       ...
                       (
                        ...
                        # only add master or secondary directory, hopefully this will work
                        if filename.startswith('master') or filename.startswith('secondary'):
                            self._i.add_watch(full_path+'/queue', self._mask)
